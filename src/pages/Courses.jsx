                ...
                <div className='text p-3'>
                  <div className='flex justify-between items-center'>
                    <div className='flex items-center'>
                      <FaBook />
                      <span className='text-[14px] ml-2'> عدد المحاضرات</span>
                    </div>
                    
                  </div>
                  <h3 className='text-black my-4 font-medium h-10'>اسم المحاضرات </h3>
                  <div className='user flex items-center'>
                    <img className='rounded-full' src='' alt='صوره' />
                    <span className='text-[14px] ml-2'> اسم </span>
                  </div>
                </div>
